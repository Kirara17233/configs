...
-- key bindings
  ...
  mouseBindings      = M.fromList $
    ...
    [ ((XMonad.modMask, button1), (\w -> focus w >> mouseMoveWindow w
                                                 >> windows W.shiftMaster))

    -- mod-button2, Raise the window to the top of the stack
    , ((XMonad.modMask, button2), (\w -> focus w >> windows W.shiftMaster))

    -- mod-button3, Set the window to floating mode and resize by dragging
    , ((XMonad.modMask, button3), (\w -> focus w >> mouseResizeWindow w
                                                 >> windows W.shiftMaster))
