# Generated by Powerlevel10k configuration wizard on 2022-06-11 at 08:52 MSK.
...
# lightest, 24h time, slanted separators, blurred heads, slanted tails, 2 lines, dotted,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='%K{#4c4d4f} %K{#404246} %K{#34373d} %k'
  # The left end of right prompt.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%K{#34373d} %K{#404246} %K{#4c4d4f} %k'
